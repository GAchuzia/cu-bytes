        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.bodyContainer}>
                ...
                <TouchableOpacity id="scanFoodButton"
                    ...
                    <Text id="scanFoodButtonText" style={styles.bodyButtonTextAlt}>Scan Food Item</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity id="browseFoodButton"
                    ...
                    <Text id="browseFoodButtonText" style={styles.bodyButtonTextAlt}>Browse Food Items</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity id="browseDiningButton"
                    ...
                    <Text id="browseDiningButtonText" style={styles.bodyButtonTextAlt}>Browse Dining Locations</Text>
                </TouchableOpacity>
