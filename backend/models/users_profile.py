...
class UsersProfile(db.Model):
    ...
    has_fish_or_shellfish_allergy = db.Column(db.Boolean, default=False)
    ...
    def create(
        ...
        user = cls(
            ...
            has_fish_or_shellfish_allergy=has_fish_or_shellfish_allergy,
            has_dairy_intolerance=has_dairy_intolerance,
            has_milk_allergy=has_milk_allergy,
    ...
    def to_json(self):
        ...
        return {
            ...
            "has_fish_or_shellfish_allergy": self.has_fish_or_shellfish_allergy,
            "has_dairy_intolerance": self.has_dairy_intolerance,
            "has_milk_allergy": self.has_milk_allergy,
